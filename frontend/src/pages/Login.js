...
const Login = () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const redirectPath = result.user.role === 'admin' ? '/admin' 
                           : result.user.role === 'coach' ? '/coach-dashboard'
                           : '/dashboard';
  ...
  const demoAccounts = [
    { email: 'admin@deepmindconcepts.com', password: 'admin123', role: 'Admin', color: 'bg-red-500' },
    { email: 'coach@deepmindconcepts.com', password: 'coach123', role: 'Coach', color: 'bg-blue-500' },
    { email: 'user@example.com', password: 'user123', role: 'User', color: 'bg-green-500' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-amber-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* Demo Accounts */}
        <Card className="border-0 shadow-lg bg-gradient-to-r from-blue-50 to-amber-50">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm text-center">Quick Demo Access</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2">
            {demoAccounts.map((account, index) => (
              ...
              >
                <div className={`w-2 h-2 rounded-full ${account.color} mr-2`}></div>
                Demo {account.role} Account
              </Button>
            ))}
          </CardContent>
        </Card>
